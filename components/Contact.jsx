...
const Contact = () => {
  ...
  return (
    <motion.div
      ...
      id='contact' className='w-full px-[12%] py-2 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center 
    bg-[length:90%_auto] dark:bg-none'>
      <motion.h4
        initial={{ y: -20, opacity: 0 }}
        whileInView={{ y: 0, opacity: 1 }}
        transition={{ delay: 0.3, duration: 0.5 }}
        className='text-center text-lg font-Ovo'>Contact with me</motion.h4>
      <motion.h2
        initial={{ y: -20, opacity: 0 }}
        whileInView={{ y: 0, opacity: 1 }}
      ...
      <motion.p
        ...
        I had love to hear from you! Whether you have a question, want to collaborate on a project, or just want to say hello, feel free to reach out to me through any of the channels below.
      </motion.p>
      <motion.form
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        ...
        <div className='grid grid-cols-auto gap-4 mb-8 mt-8'>
          <motion.input 
        ...
        >Submit now <Image src={assets.right_arrow_white} className='w-4' alt='' /></motion.button>
